"""keycery_17995 URL Configuration
...
admin.site.site_header = "Keycery"
admin.site.site_title = "Keycery Admin Portal"
admin.site.index_title = "Keycery Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="Keycery API",
        default_version="v1",
        description="API documentation for Keycery App",
    ),
    public=True,
